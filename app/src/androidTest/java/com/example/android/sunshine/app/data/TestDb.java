...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error : Weather query doesn't commit",weatherRowId != -1);
        // Query the database and receive a Cursor back
        Cursor cur = db.query(
                ...
                null);
        // Move the cursor to a valid database row
        assertTrue("Error : No records returned from weather location",cur.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error:Weather query validation failed",cur,testValues);
        // Finally, close the cursor and database
        cur.close();
        db.close();
    }
